...
const siteContentSchema = new mongoose.Schema({
  ...
  // About Us page
  aboutUs: {
    headline:    { type: String, default: 'About Wag & Walk' },
    story:       { type: String, default: 'Wag & Walk was founded to connect Naperville dog owners with trusted local walkers.' },
    mission:     { type: String, default: 'Our mission is to make dog walking accessible, safe, and enjoyable for everyone.' },
    teamMembers: [{
      name:    String,
      role:    String,
      bio:     String,
    ...
    imageUrl:    { type: String, default: 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=1200&q=80' },
  },

  // Email capture popup
  emailCapture: {
    isEnabled:    { type: Boolean, default: true },
    headline:     { type: String, default: '$5 off your first walk' },
    subtext:      { type: String, default: 'Enter your email to get a promo code for your first booking.' },
    promoCodeId:  String,
  },
